...
PageParseStatus: TypeAlias = Literal["parsed", "skipped"]
PageParseSkipReason: TypeAlias = Literal["pdf_scan_like"]
...
class PageInfo(BaseModel):
    ...
    parse_status: PageParseStatus | None = None
    parse_skip_reason: PageParseSkipReason | None = None
